...
const router = Router();
router.post("/single", requireAuth, requireRole("ADMIN", "STAFF"), uploadSingle, validateUpload, processUploadToCloudinary, (req, res) => {
...
router.post("/multiple", requireAuth, requireRole("ADMIN", "STAFF"), uploadMultiple, validateUpload, processUploadToCloudinary, (req, res) => {
